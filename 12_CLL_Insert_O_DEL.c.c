/* THIS PROGRAMME CARRIES OUT INSERTION IN ORDER AND DELETION OF NODES(ALL CASES) FROM A CIRCULAR LINKED LIST.IT ALSO DISPLAYS THE NODES.*/
...
int main()
{
    ...
    printf("Insert in ordered_circular_list :\n");
    display(h);
    h=delete_front(h);
    h=delete_front(h);
