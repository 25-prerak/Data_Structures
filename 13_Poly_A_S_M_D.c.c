/* THIS PROGRAMME CARRIES OUT ADD,SUB,MUL AND DIV. OF TWO POLYNOMIALS USING LINKED LISTS*/
#include<stdio.h>
#include<stdlib.h>
...
Polynomial 1 is :  (4.0x^3) + (5.0x^1) + (2.0x^1)
Polynomial 2 is :  (2.0x^3) + (1.0x^2) + (2.0x^1)
Added polynomial is : (6.0x^3) + (1.0x^2) + (7.0x^1) + (2.0x^1)
Multiplied polynomial is : (8.0x^6) + (4.0x^5) + (8.0x^4) + (10.0x^4) + (4.0x^4) + (5.0x^3) + (2.0x^3) + (10.0x^2) + (4.0x^2)
subtracted polynomial is : (2.0x^3) + (1.0x^2) + (3.0x^1) + (2.0x^1)
divided polynomial is : (2.0x^2) + (4.0x^1) + (2.0x^0) + (2.5x^0) + (1.0x^0) + (5.0x^-1) + (2.0x^-1) + (2.5x^-2) + (1.0x^-2)
